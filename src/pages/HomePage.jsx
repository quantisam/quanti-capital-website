  ...
  return (
    <section className="relative min-h-screen flex flex-col overflow-hidden bg-[#050505]">
      ...
      <div className="absolute inset-0">
        ...
        <div 
          className="absolute w-[800px] h-[800px] rounded-full transition-transform duration-1000 ease-out pointer-events-none"
          style={{
            left: '50%',
            top: '50%',
        ...
        <div 
          className="absolute -left-[20%] -top-[10%] w-[900px] h-[900px] rounded-full animate-pulse-slow"
          style={{
        ...
        />
        <div 
          className="absolute -right-[10%] top-[20%] w-[700px] h-[700px] rounded-full animate-pulse-slow"
          style={{
        ...
        />
        <div 
          className="absolute left-1/2 bottom-1/4 -translate-x-1/2 w-[500px] h-[500px] rounded-full"
          style={{
      ...
      {/* Hero Content */}
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center max-w-6xl mx-auto px-6 pt-32 pb-24 text-center">
        {/* Animated gradient text */}
        <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tight leading-[1.05] mb-8 max-w-5xl">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <RouterLink 
            to="/divisions" 
            className="group relative inline-flex items-center gap-3 text-black font-semibold text-base px-8 py-4 rounded-full bg-white hover:bg-white/90 transition-all duration-300 shadow-[0_0_40px_rgba(255,255,255,0.3)] hover:shadow-[0_0_60px_rgba(255,255,255,0.4)] hover:scale-105"
          >
            Explore Divisions
          ...
          <RouterLink 
            to="/contact" 
            className="group inline-flex items-center gap-3 text-white/80 hover:text-white font-medium text-base px-8 py-4 rounded-full bg-white/[0.05] border border-white/[0.1] hover:bg-white/[0.1] hover:border-white/[0.2] transition-all duration-300"
          >
            Get in Touch
...
export const StatsSection = () => (
  <section className="relative bg-[#050505] py-28 overflow-hidden border-t border-white/[0.06]">
    <div className="max-w-6xl mx-auto px-6">
      <div className="grid md:grid-cols-3 gap-8">
        <GlassCard className="p-10 text-center" glow>
          <p className="text-white/50 text-xs font-semibold uppercase tracking-[0.2em] mb-5">INTEGRATED PLATFORM</p>
          <h3 className="text-5xl md:text-6xl font-bold text-white mb-4">4 Divisions</h3>
          <p className="text-white/50 text-base">Brokerage, Logistics, Hedging, Markets</p>
        </GlassCard>
        <GlassCard className="p-10 text-center" glow>
          <p className="text-white/50 text-xs font-semibold uppercase tracking-[0.2em] mb-5">GLOBAL REACH</p>
          <h3 className="text-5xl md:text-6xl font-bold text-white mb-4">5 Continents</h3>
          <p className="text-white/50 text-base">Connecting mines to manufacturers worldwide</p>
        </GlassCard>
        <GlassCard className="p-10 text-center" glow>
          <p className="text-white/50 text-xs font-semibold uppercase tracking-[0.2em] mb-5">MISSION</p>
          <h3 className="text-5xl md:text-6xl font-bold text-white mb-4">Future-Ready</h3>
          <p className="text-white/50 text-base">Building resilient supply chains for tomorrow's industries</p>
        </GlassCard>
      </div>
    </div>
  </section>
  ...
  <section className="relative bg-[#050505] py-28 overflow-hidden">
    <div className="max-w-6xl mx-auto px-6">
      <div className="text-center mb-16">
        <p className="text-white/50 text-xs font-semibold uppercase tracking-[0.2em] mb-6">WHY QUANTI</p>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-12">
        <GlassCard className="p-10" glow>
          <h3 className="text-xl md:text-2xl font-semibold text-white mb-5">Solving Offtake Challenges</h3>
        ...
        <GlassCard className="p-10" glow>
          <h3 className="text-xl md:text-2xl font-semibold text-white mb-5">Western Integration</h3>
          <p className="text-white/50 leading-relaxed">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <GlassCard className="p-10" glow>
          <h3 className="text-xl font-semibold text-white mb-5">For Suppliers</h3>
          <p className="text-white/50 leading-relaxed">
        ...
        <GlassCard className="p-10" glow>
          <h3 className="text-xl font-semibold text-white mb-5">For Buyers</h3>
          <p className="text-white/50 leading-relaxed">
    ...
    <div className="max-w-6xl mx-auto px-6">
      <div className="grid md:grid-cols-3 gap-8">
        <GlassCard className="p-10 text-center">
          <h3 className="text-3xl md:text-4xl font-bold text-white mb-5">Balanced</h3>
          <p className="text-white/50 leading-relaxed">Giving suppliers control while diversifying buyer risks</p>
        </GlassCard>
        <GlassCard className="p-10 text-center">
          <h3 className="text-3xl md:text-4xl font-bold text-white mb-5">Connected</h3>
          <p className="text-white/50 leading-relaxed">Integrating American Resources into global supply chains</p>
        </GlassCard>
        <GlassCard className="p-10 text-center">
          <h3 className="text-3xl md:text-4xl font-bold text-white mb-5">Sustainable</h3>
          <p className="text-white/50 leading-relaxed">Market-driven demand beyond government programs</p>
        </GlassCard>
      </div>
    </div>
  </section>
...
export const DivisionsPreviewSection = () => {
  ...
  return (
    <section id="divisions" className="relative bg-[#050505] py-28 overflow-hidden border-t border-white/[0.06]">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          <p className="text-white/50 text-xs font-semibold uppercase tracking-[0.2em] mb-5">OUR DIVISIONS</p>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {divisions.map((division) => (
            <GlassCard key={division.name} className="p-10 group">
              <div className="mb-8">
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-white/[0.08] to-white/[0.02] border border-white/[0.1] flex items-center justify-center shadow-[0_4px_16px_rgba(0,0,0,0.3)] group-hover:scale-110 transition-transform duration-300">
                  <division.icon className="w-7 h-7 text-white/70" strokeWidth={1.5} />
                </div>
              </div>
              <h3 className="text-2xl font-semibold text-white mb-2">{division.name}</h3>
              <p className="text-xs font-semibold text-white/40 uppercase tracking-wider mb-5">{division.subtitle}</p>
              <p className="text-white/50 leading-relaxed mb-8">{division.description}</p>
              <ul className="space-y-3 mb-8">
                {division.bullets.map((bullet, idx) => (
                  <li key={idx} className="flex items-start gap-3 text-white/45 text-sm">
              ...
              <RouterLink 
                to={division.href}
                className="inline-flex items-center gap-2 text-white font-medium hover:gap-3 transition-all px-5 py-2.5 rounded-full bg-white/[0.05] border border-white/[0.08] hover:bg-white/[0.1] hover:border-white/[0.15]"
              >
...
export const CTASection = () => (
  <section className="relative bg-[#050505] py-36 overflow-hidden">
    ...
    <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[1000px] h-[500px] bg-gradient-radial from-white/[0.03] to-transparent rounded-full blur-[180px]" />

    <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
      <GlassCard className="p-12 md:p-20" hover={false} glow>
        ...
        <RouterLink 
          to="/contact" 
          className="group inline-flex items-center gap-3 bg-white text-black px-12 py-6 rounded-full text-lg font-semibold shadow-[0_0_50px_rgba(255,255,255,0.25),0_8px_32px_rgba(0,0,0,0.3)] hover:shadow-[0_0_70px_rgba(255,255,255,0.35),0_12px_48px_rgba(0,0,0,0.4)] hover:scale-[1.03] transition-all duration-300"
        >
